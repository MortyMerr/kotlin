...
public class DiagnosticsNativeTestGenerated extends AbstractDiagnosticsNativeTest {
    ...
    @TestMetadata("preferAtomicReference.kt")
    public void testPreferAtomicReference() throws Exception {
        runTest("compiler/testData/diagnostics/nativeTests/preferAtomicReference.kt");
    }
